 ...
 * @author szoplakz
 */
public class AuthorRequestForm extends javax.swing.JDialog {

    /**
     * Creates new form AuthorRequestForm
     */
    public AuthorRequestForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthorRequestForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AuthorRequestForm dialog = new AuthorRequestForm(new javax.swing.JFrame(), true);
