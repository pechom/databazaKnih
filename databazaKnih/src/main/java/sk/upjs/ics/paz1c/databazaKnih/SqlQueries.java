...
public class SqlQueries {
    ...
    public static final String SELECT_ALL_AUTHORS = "SELECT author.idauthor, author.name, author.birth, author.death, author.nationality, "
            ...
            + "JOIN authorreview ON author.authorreview_idauthorreview=authorreview.idauthorreview WHERE author.isActive=1 and "
            + "author.verificationStatus=1 ORDER BY author.idauthor";
    ...
    public static final String SELECT_ALL_BOOKS = "SELECT book.idbook, book.name, book.year, book.numberOfPages. book.ISBN, book.descroption "
            ...
            + "tagofbook.book_idbook WHERE book.isActive=1 and book.verificationStatus=1 ORDER BY book.numberInChart";
    ...
    public static final String SELECT_ALL_REQUESTS = "SELECT request.idrequest, request.content, request.book_idbook, request.author_idauthor "
            + "FROM request JOIN author ON author.idauthor=request.author_idauthor, JOIN book ON book.idbook=request.book_idbook ORDER BY request.idrequest";
    ...
    public static final String SELECT_REQUEST_BY_ID = "SELECT request.idrequest, request.content, request.book_idbook, request.author_idauthor "
            + "FROM request JOIN author ON author.idauthor=request.author_idauthor, JOIN book ON book.idbook=request.book_idbook WHERE request.idrequest=";
