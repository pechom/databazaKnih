CREATE DATABASE  IF NOT EXISTS `databaza-knih-test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `databaza-knih-test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: databaza-knih-test
-- ------------------------------------------------------
...
--
-- Dumping events for database 'databaza-knih-test'
--

--
-- Dumping routines for database 'databaza-knih-test'
--
...
-- Dump completed on 2017-01-04 13:26:56
